...
import type { ParentHomeworkAttachment } from '@/types/parent-portal'
...
function getAttachmentName(file: ParentHomeworkAttachment) {
  return getAttachmentDisplayName(file)
}

function isImageAttachment(file: ParentHomeworkAttachment) {
  return isImageAttachmentLike(file)
}

function isPdfAttachment(file: ParentHomeworkAttachment) {
  return isPdfAttachmentLike(file)
}

function getMaterialType(file: ParentHomeworkAttachment) {
